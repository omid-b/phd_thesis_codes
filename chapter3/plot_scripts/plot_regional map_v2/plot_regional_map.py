...
USAGE:
  python plot_regional_map.py <out_pdf> <fan-diagrams>
...
output_fname = os.path.abspath(sys.argv[1])

if len(sys.argv) > 2:
    if os.path.isfile(sys.argv[2]):
        print(f"Input <points>: '{sys.argv[2]}'\n")
...
#             'Ocean_Basemap' #10
#             ]
# service = services[8] #choose from services in the above line
# esri_dpi = int(300)
# xpixels = int(5000)
# verbose = True
...
world = os.path.abspath("world_maps/BM02_17280x8640_bright.png")
# world = os.path.abspath("world_maps/nasa_bluemarble.png")
...
plt.tight_layout()
plt.savefig(f"{output_fname}",format="pdf", dpi=output_dpi)
print(f"\n{output_fname} has been generated!\n\n")
